...
var name = prompt("what is your tamagotchis name?");

var myTamagotchi = new Obj(name);

$(function () {
  var generateEggButton = document.getElementById('getTamagotchiEgg');
  var generateStatsButton = document.getElementById('getTamagotchiStats');
  var tamagotchiState = document.getElementById('stage');
  var explainer = document.getElementById('explain');
  var explainer2 = document.getElementById('explain2');
  var gameplay = document.getElementById('game-play');
  var playStatement = document.getElementById('playStatement');
  var playButton = document.getElementById('tamagotchiPlay');
  var careButton = document.getElementById('tamagotchiCare');
  var feedButton = document.getElementById('tamagotchiFeed');
  var ageButton = document.getElementById('getTamagotchiAge');
  ...
  var tamagotchiBaseLevels = function tamagotchiBaseLevels() {
  ...
  var tamagotchiPlayLevels = function tamagotchiPlayLevels() {
    var playInput = document.getElementById('playInputField').value;
  ...
  var tamagotchiCareLevels = function tamagotchiCareLevels() {
    var careInput = document.getElementById('careInputField').value;
    playStatement.innerHTML = myTamagotchi.care(careInput);
  };
  careButton.addEventListener('click', tamagotchiCareLevels);

  var tamagotchiFoodLevels = function tamagotchiFoodLevels() {
    var foodInput = document.getElementById('foodInputField').value;
    playStatement.innerHTML = myTamagotchi.eat(foodInput);
  };
  feedButton.addEventListener('click', tamagotchiFoodLevels);

  var tamagotchiAge = function tamagotchiAge() {
    var toggleDisplay = document.getElementById('ageDisplay');
...
var Tamagotchi = function () {
  _createClass(Tamagotchi, [{
    ...
    value: function age() {
      ...
      var askDate2 = Date.parse(askDate);
      console.log(askDate2);

      var birthDate = this.ageStart;
      console.log(this.ageStart);
      var birthDate2 = Date.parse(birthDate);
      console.log(birthDate2);
      var age = askDate2 - birthDate2;

      var ageReadable = Math.floor(age / 1000 / 60);

      if (ageReadable > 60) {
        var ageHrs = Math.round(ageReadable / 1000 / 60 / 60) + 1;
